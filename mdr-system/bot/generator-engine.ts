...
async function generateDynamicContent(options: GenerationOptions): Promise<string> {
  ...
  if (onlineData.length === 0) {
    return `FormAT attempted to synthesize a ${type} for "${topic}" but could not reach external sources. Please try again or refine your prompt.`;
  }
